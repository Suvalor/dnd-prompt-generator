...
- DeepSeek LLM API is sufficient for generating structured, copy-ready English prompts.
...
5. Build Python backend with DeepSeek API integration.
...
- Risk: DeepSeek JSON output may be unstable.
